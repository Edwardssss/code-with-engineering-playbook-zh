...
There are many options when working with Source Control. In [ISE](../handbook-overview/ise.md) we use [AzureDevOps](https://azure.microsoft.com/en-us/services/devops/) for private repositories and [GitHub](https://github.com/) for public repositories.

## Goal

* Following industry best practice to work in geo-distributed teams which encourage contributions from all across [ISE](../handbook-overview/ise.md) as well as the broader OSS community
...
* [ISE Git details](git-guidance/README.md)details on how to use Git as part of a [ISE](../handbook-overview/ise.md) project.
